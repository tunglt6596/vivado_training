...
proc create_hier_cell_convolution_unit { parentCell nameHier } {
  ...
  set_property -dict [ list CONFIG.FP_FRAC_LENGTH {0} CONFIG.FP_WORD_LENGTH {11} CONFIG.KERNEL_00 {1} CONFIG.KERNEL_01 {2} CONFIG.KERNEL_02 {1} CONFIG.KERNEL_10 {0} CONFIG.KERNEL_11 {0} CONFIG.KERNEL_12 {0} CONFIG.KERNEL_20 {1025} CONFIG.KERNEL_21 {1026} CONFIG.KERNEL_22 {1025}  ] $AXI_Convolution_Fixed_Point_3x3_0
