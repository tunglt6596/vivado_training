...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.c_include_mm2s_dre {0} CONFIG.c_include_s2mm_dre {0} CONFIG.c_include_sg {0} CONFIG.c_m_axi_mm2s_data_width {64} CONFIG.c_mm2s_burst_size {32} CONFIG.c_s2mm_burst_size {32} CONFIG.c_sg_include_stscntrl_strm {0} CONFIG.c_sg_length_width {23}  ] $axi_dma_0
  ...
  set_property -dict [ list CONFIG.FIFO_DEPTH {1024}  ] $axis_data_fifo_0

  # Create instance: axis_data_fifo_1, and set properties
  set axis_data_fifo_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:1.1 axis_data_fifo_1 ]
  set_property -dict [ list CONFIG.FIFO_DEPTH {1024}  ] $axis_data_fifo_1
  ...
  connect_bd_intf_net -intf_net axi_conv_fp_3x3_0_M_AXIS [get_bd_intf_pins axi_conv_fp_3x3_0/M_AXIS] [get_bd_intf_pins axis_data_fifo_1/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axi_conv_fp_3x3_0/S_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
