...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.c_include_mm2s {0} CONFIG.c_include_s2mm_dre {1} CONFIG.c_include_sg {0} CONFIG.c_sg_include_stscntrl_strm {0}  ] $axi_dma_0
  ...
  set_property -dict [ list CONFIG.C_GPIO_WIDTH {8}  ] $axi_gpio_1
  ...
  set sample_generator_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:sample_generator:1.0 sample_generator_0 ]
  ...
  connect_bd_intf_net -intf_net sample_generator_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins sample_generator_0/M_AXIS]
