...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net bypass_axis_0_s_axis_tready [get_bd_ports s_axis_tready] [get_bd_pins bypass_axis_0/s_axis_tready]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins bypass_axis_0/m_axis_aclk] [get_bd_pins bypass_axis_0/s_axi_aclk] [get_bd_pins bypass_axis_0/s_axis_aclk]
  connect_bd_net -net m_axis_tready_1 [get_bd_ports m_axis_tready] [get_bd_pins bypass_axis_0/m_axis_tready]
  connect_bd_net -net reset_n_1 [get_bd_ports reset_n] [get_bd_pins bypass_axis_0/m_axis_aresetn] [get_bd_pins bypass_axis_0/s_axi_aresetn] [get_bd_pins bypass_axis_0/s_axis_aresetn]
  connect_bd_net -net s_axi_awaddr_1 [get_bd_ports s_axi_awaddr] [get_bd_pins bypass_axis_0/s_axi_awaddr]
  connect_bd_net -net s_axi_awvalid_1 [get_bd_ports s_axi_awvalid] [get_bd_pins bypass_axis_0/s_axi_awvalid]
  connect_bd_net -net s_axi_wdata_1 [get_bd_ports s_axi_wdata] [get_bd_pins bypass_axis_0/s_axi_wdata]
  connect_bd_net -net s_axi_wstrb_1 [get_bd_ports s_axi_wstrb] [get_bd_pins bypass_axis_0/s_axi_wstrb]
  connect_bd_net -net s_axi_wvalid_1 [get_bd_ports s_axi_wvalid] [get_bd_pins bypass_axis_0/s_axi_wvalid]
  connect_bd_net -net s_axis_tdata_1 [get_bd_ports s_axis_tdata] [get_bd_pins bypass_axis_0/s_axis_tdata]
  connect_bd_net -net s_axis_tvalid_1 [get_bd_ports s_axis_tvalid] [get_bd_pins bypass_axis_0/s_axis_tvalid]
